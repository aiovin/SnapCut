# SnapCut - A tool for a quick image cropping.
<img src="https://github.com/aiovin/SnapCut/blob/main/example (multiple images).gif" width="600px">
<i>Just select the cropping area and immediately move on to the next image.</i>
...
<img src="https://github.com/aiovin/SnapCut/blob/main/example (single image).gif" width="600px">
<i>Cut multiple elements from a single image.</i>

*******************

# SnapCut - Программа для быстрой обрезки изображений.
<img src="https://github.com/aiovin/SnapCut/blob/main/example (multiple images).gif" width="600px">
<i>Просто выделите область обрезки и мгновенно переключитесь на следующее изображение.</i>

<h2><b>Особенности программы.</b></h2>
...
- Пробел для пролистывания изображения. Программа завершится после последнего изображения;

- Пролистывание изображение стрелками на клавиатуре а также колесиком мыши. Программа не завершается на последнем изображении;

- Оконный и полноэкранный режимы. Смена клавишей F. Работает только с русской и английской раскладками;
...
<img src="https://github.com/aiovin/SnapCut/blob/main/example (single image).gif" width="600px">
<i>Вырежьте множество элементов из одного изображения.</i>

*******************

All example images are designed by Freepik.
