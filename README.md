...
<img src="https://github.com/aiovin/SnapCut/blob/main/example (multiple images).gif" width="600px">
<i>Просто выделите область обрезки и мгновенно перключитесь на следующее изображение.</i>
...
- Пробел для пролистыания изображения. Программа завершится после последнего изображения;
...
<img src="https://github.com/aiovin/SnapCut/blob/main/example (single image).gif" width="600px">
<i>Вырежте множество элементов из одного изображения.</i>
